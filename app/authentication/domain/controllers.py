...
from app.authentication.domain.exceptions import UserNotFoundException, InvalidCredentialsException, InvalidTokenException
...
class LoginController:
    def __init__(self, user_repository: UserRepository, token_repository: TokenRepository, hashing_service: HashingService):
        self.user_repository = user_repository
